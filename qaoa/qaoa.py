...
# Parametros economicos (igual que la instancia original).
...
# Costo consolidado C_ih = oferta_i * c * (distancia efectiva productor -> hub).
# La distancia efectiva usa distancias geograficas REALES (haversine, km):
# min sobre puntos de ruteo de  d_ih(prod->ruteo) + alpha * d_hj(ruteo->hub).
eff_dist = (
...
print(f"  Productores: {productores}")
